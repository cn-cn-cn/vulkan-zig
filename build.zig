...
pub fn build(b: *std.Build) void {
    ...
    const maybe_registry = b.option(std.Build.LazyPath, "registry", "Set the path to the OpenXR registry (xr.xml)");
    ...
    if (maybe_registry) |registry| {
        ...
        xr_generate_cmd.addFileArg(registry);
        ...
        ref_all_decls_test.root_module.addImport("openxr", xr_zig_module);
